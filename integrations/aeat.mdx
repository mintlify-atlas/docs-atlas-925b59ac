...
description: "Validate Spanish NIFs and CIFs against the AEAT tax census. Single checks, bulk validation up to 20,000 NIFs, and cache-only lookups — all in Eme2App."
---
