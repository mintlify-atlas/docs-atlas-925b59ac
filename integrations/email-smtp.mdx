...
<Tabs>
  ...
  <Tab title="Brevo (Sendinblue)">
    ...
    Eme2App defaults to Brevo's port **2525**, which bypasses restrictions on hosting providers that block the standard SMTP ports 25, 465, and 587 on free-tier plans. You can override this by setting `smtp_port` explicitly.
  </Tab>
