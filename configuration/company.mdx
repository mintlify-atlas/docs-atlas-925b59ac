---
title: "Eme2App Company: Profile, SMTP Email, and Certificates"
sidebarTitle: "Company"
description: "Configure company profile, logo, SMTP provider, AEAT certificate, fiscal advisory, accounting counters, and custom parameters in Eme2App."
---
...
`GET /api/empresa/aplicaciones-asesoria` returns the list of accounting-software application names available for the advisory integration selector (e.g., A3, ContaPlus, Sage). It requires authentication but not an active `empresa_id`.
