...
description: "Eme2App is a full-stack invoicing and budgeting SaaS covering invoices, quotes, delivery notes, expenses, treasury, PDF design, and AEAT tax validation for Spanish companies."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Core Modules" icon="cube" href="/modules">
