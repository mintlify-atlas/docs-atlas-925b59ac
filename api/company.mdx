...
description: "REST API reference for Eme2App company settings. Retrieve and update company profile, upload logo, configure SMTP, manage AEAT certificates, and handle accounting data."
---
