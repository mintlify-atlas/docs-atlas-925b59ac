...
sidebarTitle: "Users"
description: "REST API reference for Eme2App user management. Create, update, and delete users within your company. Requires admin role. Distinct from the superadmin adminapp endpoints."
---
